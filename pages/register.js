...
const RegisterSchema = Yup.object().shape({
  ...
  password: Yup.string()
    .matches(
      ...
      "Min 8 characters , Max 20 characters At least one uppercase character ,one lowercase character, one digit and one special character"
    )
    .required("Required")
});
        ...
        <div className="w-full md:w-1/2 lg:w-1/3">
          ...
          >
            {({
              ...
              >
                <h2 className="text-md font-medium my-2 text-black">
                  Register
                </h2>
